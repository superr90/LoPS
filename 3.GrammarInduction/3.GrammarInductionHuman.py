        ...
        while I < 100000:
            ...
            for i, cr in enumerate(S):
                ...
                for j, cl in enumerate(S):
                    ...
                    # if tempCl + tempCr == "EAGL":
                    #     print("EAGL", score2 / score1, U[1, 1] / len(seq))
                    # if tempCl + tempCr == "EALG":
                    #     print("EALG", score2 / score1, U[1, 1] / len(seq))
                    # if tempCl + tempCr == "SE":
                    #     print("SE", score2 / score1, U[1, 1] / len(seq))

                    # if (tempCl + tempCr)[0] == "1" or (tempCl + tempCr)[0] == "2":
                    #     print(tempCl + tempCr, score2 / score1, U[1, 1] / len(seq))
