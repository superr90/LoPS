...
if __name__ == '__main__':
    ...
    index, JustBayesianNetworkAccuracy, JustBayesianMarkovNetworkStd = JustBeliefNetworkAccuracy()
    index, MarkovNetworkAccuracy, MarkovNetworkStd = MarkovNetworkAccuracy()

    result = {
        "index": index,
        "BA": BayesianNetworkAccuracy,
        "BS": BayesianMarkovNetworkStd,
        "JBA": JustBayesianNetworkAccuracy,
        "JBS": JustBayesianMarkovNetworkStd,
        "MA": MarkovNetworkAccuracy,
        "MS": MarkovNetworkStd,
    }

    with open("./data/accuracy.pkl","wb") as file:
    ...
    #            )
    # plt.tight_layout()
    # plt.savefig("SupFig-sim1-PGM.pdf")
    # plt.show()
