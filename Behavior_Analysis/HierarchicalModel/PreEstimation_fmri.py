...
if __name__ == '__main__':
    ...
    fileFolder = "../../fmri_data_process/fmriCorrectedTileData/"
    saveFolder = "../../fmri_data_process/fmriUtilityData/"
    fileNames = os.listdir(fileFolder)
    index=fileNames.index("180522-502-21-Nov-2022-1.pkl")
    filePaths = [fileFolder + f for f in fileNames]

    CalculateUtility(filePaths[index],saveFolder)
