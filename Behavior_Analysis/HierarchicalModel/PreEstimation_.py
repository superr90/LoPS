...
from Behavior_Analysis.HierarchicalModel.Agent.GlobalAgent import SimpleGlobal as GlobalAgent
...
if __name__ == '__main__':
    # path = "../../Data/1000_trial_data_Omega1.pkl"
    # with open(path, 'rb') as file:
    #     data = pickle.load(file)
    #
    # data = data[
    #     ['file', 'pacmanPos', 'ghost1Pos', 'ghost2Pos', 'ifscared1', 'ifscared2', 'beans', 'energizers', 'fruitPos',
    #      'Reward', 'pacman_dir']]
    # path = "../../Data/TestExample/1000_trial_data_Omega.pkl"
    # with open(path, 'wb') as file:
    #     pickle.dump(data,file)
    # path = "../../Data/TestExample/1000_trial_data_Omega.pkl"
    save_base = "../../Data/TestExample/"
    filename = "../../monkey_data_process/Omega/000.pkl"
    filename_list = [
        filename
    ]
    preEstimation(filename_list, save_base)
