...
if __name__ == '__main__':
    ...
    path = "../../monkey_data_before/monkeyCorrectedUtilityData/data2018/"
    fileFolder = "../../monkey_data_before/monkeyUtilityData/data2018/"
    saveFolder = "../../monkey_data_before/monkeyCorrectedUtilityData/data2018/"
    fileNames = os.listdir(fileFolder)
    filePaths = [fileFolder + f for f in fileNames]

    # CorrectUtility(filePaths[0],adjacent_data,saveFolder)
